      ...
      <div className="container px-4 md:px-6 py-8 md:py-12">
        <div className="grid gap-8 md:grid-cols-4">
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              Empowering citizens through transparent reporting and verification.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/submit-case" className="text-muted-foreground hover:text-foreground">
                  Submit a Case
                </Link>
              </li>
              <li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/data-policy" className="text-muted-foreground hover:text-foreground">
                  Data Policy
                </Link>
              </li>
              <li>
        ...
        <div className="mt-8 border-t pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-xs text-muted-foreground">
            © {new Date().getFullYear()} Citizen Observatory System. All rights reserved.
          </p>
